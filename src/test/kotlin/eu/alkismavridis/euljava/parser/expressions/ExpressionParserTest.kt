...
internal class ExpressionParserTest {
    ...
    fun shouldParseIntegerToken() {
        ...
        assertIntegerLiteral(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 5, 32, true, 1, 1)
    ...
    fun shouldParseBooleanToken() {
        ...
        assertBooleanLiteral(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), true, 1, 1)
        assertThat(source.getNextToken(false)).isNull()
    }
    ...
    fun requireExpression_shouldThrowOnEmptyExpression() {
        ...
        assertThatExceptionOfType(ParserException::class.java)
                .isThrownBy { parser.requireExpression(ExpressionBreaker.STATEMENT_EXPRESSION) }
    }
    ...
    fun readExpression_shouldReturnNullOnEmptyExpression() {
        ...
        assertThat(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION)).isNull()
    }
    ...
    fun shouldParseSimpleInfixExpression() {
        ...
        val asInfix = assertInfixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldParseLtrOperatorsOfSamePrecedence() {
        ...
        val topLevelInfix = assertInfixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldHandleParenthesis() {
        ...
        val exp1 = assertInfixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldParseSimplePrefixExpression() {
        ...
        val asPrefix = assertPrefixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldParseMultiplePrefixOperatorsAsRtlWithSamePrecedence() {
        ...
        val exp1 = assertPrefixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldParseSimpleSuffixExpression() {
        ...
        val asSuffix = assertSuffixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldParseMultipleSuffixOperatorsAsLtrWithSamePrecedence() {
        ...
        val exp1 = assertSuffixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 1)
    ...
    fun shouldHandleSuffixInParenthesis() {
        ...
        val exp1 = assertSuffixExpression(parser.readExpression(ExpressionBreaker.STATEMENT_EXPRESSION), 1, 2)
        assertSpecialCharacter(exp1.operator, SpecialCharType.DOUBLE_PLUS, 1, 8)
